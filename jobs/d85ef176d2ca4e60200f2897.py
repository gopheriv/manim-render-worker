...
class AetherLabScene(Scene):
    def construct(self):
        ...
        l1_label = MathTex(r"L_1 = 1.0", color=GOLD_E).scale(0.4).next_to(rod1, RIGHT, buff=0.2)
        l2_label = MathTex(r"L_2 = 1.0", color=GOLD_E).scale(0.4).next_to(rod2, RIGHT, buff=0.2)
        ...
        r1_label = MathTex(r"\vec{r}_1", color=RED_E).scale(0.4).next_to(r1_vector.get_center(), LEFT, buff=0.1)
        r2_label = MathTex(r"\vec{r}_2", color=RED_E).scale(0.4).next_to(r2_vector.get_center(), DOWN, buff=0.1)
        ...
        def update_r1_label(lbl):
            lbl.next_to(r1_vector.get_center(), LEFT, buff=0.1)
        
        def update_r2_label(lbl):
            lbl.next_to(r2_vector.get_center(), DOWN, buff=0.1)
