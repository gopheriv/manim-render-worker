...
class AetherLabScene(Scene):
    def construct(self):
        ...
        # Create spiral path for dominoes
        spiral_path = VGroup()
        spiral_points = []
        for i in range(20):
            angle = i * PI / 4
        ...
        self.play(Rotate(domino1_group, angle=-PI/2, about_point=domino1_group.get_top()), 
        ...
        self.play(Rotate(domino2_group, angle=-PI/2, about_point=domino2_group.get_top()),
        ...
        self.play(Rotate(domino3_group, angle=-PI/2, about_point=domino3_group.get_top()),
        ...
        for i, term in enumerate(domino_terms):
            ...
            self.play(Rotate(domino_grp, angle=-PI/2, about_point=domino_grp.get_top()),
        ...
        final_domino = Rectangle(width=1.2, height=0.6, color=RED, fill_opacity=0.9, stroke_width=2)
        ...
        self.play(Rotate(final_domino_group, angle=-PI/4, about_point=final_domino_group.get_top()),
        ...
        for i, domino in enumerate(reversed(all_dominoes)):
            ...
            self.play(Rotate(domino, angle=PI/2, about_point=domino.get_top()),
