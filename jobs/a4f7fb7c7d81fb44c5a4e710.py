...
class AetherLabScene(Scene):
    def construct(self):
        ...
        m1_label = always_redraw(lambda: Tex("m_1", color=GOLD_E).scale(0.4).next_to(m1.get_center(), DOWN, buff=0.1))
        m2_label = always_redraw(lambda: Tex("m_2", color=GOLD_E).scale(0.4).next_to(m2.get_center(), DOWN, buff=0.1))
        ...
        theta1_label = always_redraw(lambda: Tex("\\theta_1", color=BLUE_E).scale(0.3).next_to(angle_arc1, LEFT, buff=0.1))
        theta2_label = always_redraw(lambda: Tex("\\theta_2", color=BLUE_E).scale(0.3).next_to(angle_arc2, LEFT, buff=0.1))
        ...
        r1_label = always_redraw(lambda: Tex("\\vec{r}_1", color=GOLD_E).scale(0.35).next_to(r1_vector.get_center(), UP, buff=0.1))
        r2_label = always_redraw(lambda: Tex("\\vec{r}_2", color=GOLD_E).scale(0.35).next_to(r2_vector.get_center(), UP, buff=0.1))
